(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/GameElements/MODCharacter.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'aec24wA//VGTLIP2a5TZHY1', 'MODCharacter', __filename);
// Script/GameElements/MODCharacter.js
...
cc.Class({
    ...
    updateDirection: function updateDirection(motionState) {
        if (motionState > 0) {
    ...
    setMotionState: function setMotionState(motionState) {
    ...
    receivingInput: function receivingInput(data) {
        if (this.onSendingInput != null) {
            return;
        }
        if (data['motion'] != null) {
    ...
    onLoad: function onLoad() {
        ...
        collider.points = [cc.v2(30, 97), cc.v2(60, 87), cc.v2(80, 70), cc.v2(90, 55), cc.v2(95, 30), cc.v2(100, -10), cc.v2(120, -51), cc.v2(117, -70), cc.v2(110, -77), cc.v2(95, -79), cc.v2(84, -94), cc.v2(68, -100), cc.v2(56, -100), cc.v2(47, -127), cc.v2(31, -131), cc.v2(15, -127), cc.v2(6, -100), cc.v2(-6, -100), cc.v2(-15, -127), cc.v2(-31, -131), cc.v2(-47, -127), cc.v2(-56, -100), cc.v2(-68, -100), cc.v2(-84, -94), cc.v2(-95, -79), cc.v2(-110, -77), cc.v2(-117, -70), cc.v2(-120, -51), cc.v2(-100, -10), cc.v2(-95, 30), cc.v2(-90, 55), cc.v2(-80, 70), cc.v2(-60, 87), cc.v2(-30, 97), cc.v2(0, 100)];
...
cc._RF.pop();
        ...
        //# sourceMappingURL=MODCharacter.js.map
